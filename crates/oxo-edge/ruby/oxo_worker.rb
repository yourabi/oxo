...
#
# TCP Rack worker for the Hyper edge's supervised handler. Uses the Ruby standard
# library for HTTP framing and loads the app through Rack. Validate the shared
# secret, accept bounded Content-Length requests and close after one exchange.
