...
mod tests {
    ...
    fn cert_key_pair_leaves_previous_pair_intact_when_key_staging_fails() {
        // the certificate and key are both staged before either is renamed into place,
    ...
    // ---- production-directory consent + account pinning ----
    ...
    // ---- supervisor reload marker + rollback surface ----
    ...
    // ---- issued-pair validation + marker-first persist + latch ----
